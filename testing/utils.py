...
class TestProgressMonitor:
    ...
    def update_progress(self, test_name: str, status: str) -> None:
        ...
        self.state_history.append(
            {"test_name": test_name, "status": status, "timestamp": current_time}
        )
    ...
    def check_stalled_tests(self, timeout: float) -> List[str]:
        ...
        stalled = [
            ...
            if state["status"] == "running" and (current_time - state["timestamp"]) > timeout
        ]
    ...
    def get_progress_summary(self) -> Dict[str, Any]:
        ...
        running = sum(1 for state in self.test_states.values() if state["status"] == "running")
            ...
            while attempt < config.max_retries:
                try:
                    ...
                    if attempt < config.max_retries:
                        ...
                        logger.warning(f"Attempt {attempt} failed: {e}. Retrying in {backoff:.1f}s")
                        time.sleep(backoff)
...
class TestEnvironment:
    ...
    def __init__(
        ...
        self.quotas = quotas or {"cpu": "2", "memory": "2Gi", "pods": "10"}
    ...
    def teardown(self) -> None:
        ...
        try:
            self.api.delete_namespace(
                name=self.namespace, body=client.V1DeleteOptions(propagation_policy="Foreground")
            )
    ...
    def get_available_resources(self) -> Set[str]:
        ...
        try:
            ...
            return {resource.name for resource in api_resources.resources if resource.namespaced}
        except ApiException as e:
    ...
    def _create_resource_quota(self) -> None:
        ...
        self.api.create_namespaced_resource_quota(self.namespace, quota_spec)
    ...
    def create_fixture(self, fixture_config: Dict[str, Any]) -> Any:
        ...
        raise NotImplementedError(f"Creation of fixture type '{fixture_type}' not implemented")
